This repository is a fork of @ethereum-ts [typechain-target-truffle](https://github.com/ethereum-ts/TypeChain/tree/master/packages/typechain-target-truffle) package to make it compatible with Truffle v5.
